...
if __name__ == "__main__":
    ...
    assert cfg.clip_ratio_low == 0.2
    assert cfg.clip_ratio_high == 0.28
    assert cfg.norm_advantages is True
    assert cfg.loss_agg in {"token_mean", "seq_mean"}
    print("algo/base.py self-test passed")
