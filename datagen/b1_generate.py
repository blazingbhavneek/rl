...
async def process_function(
    ...
    raw, _ = await agent.run(
        ...
        f"Parameters are given in correct order with types. "
...
async def main():
    ...
    print(f"[b1] Found {len(json_files)} functions")
